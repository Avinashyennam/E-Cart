            ...
            <div className="popular flex flex-col items-center">
                ...
                <div className="offers-sec flex gap-16 items-center">
                    ...
                    <div className="text flex flex-col items-center gap-4">
                        ...
                        <div className='button-div bg-red-500 px-3 py-2 rounded-lg w-1/5 text-center lg: w-2/5'>
